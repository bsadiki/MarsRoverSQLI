...
public class PathDrawer {
    String draw(List<PathPosition> pathPositions){
        ...
        String[][] drawingMatrix = initializeMatrix(firstAndLastPosition(pathPositions)[0].distanceFromOtherPosition(firstAndLastPosition(pathPositions)[1]));
        int [] origin = new int[]{firstAndLastPosition(pathPositions)[0].getX(), firstAndLastPosition(pathPositions)[0].getY()};
